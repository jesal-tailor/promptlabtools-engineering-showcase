...
I built a public-safe AI Platform Engineering showcase for agentic workflow control planes: deterministic mock agents, human approval governance, prompt and tool registries, evaluation checks, repository boundaries, observability, health/readiness endpoints, 100+ tests and CI. Built with Next.js, TypeScript, Vitest and GitHub Actions.
